...
namespace Base.Dal
{
    public  class RepositoryBa
    {
        private IDbConnection conn;
        private IDbTransaction transaction;

        public RepositoryBa(IDbConnection _conn, IDbTransaction _transaction)
        {
            conn = _conn;
        ...
        {
            return SimpleCRUD.Get<T>(conn, id, transaction);
        }
        ...
        {
            return SimpleCRUD.GetList<T>(conn, whereConditions, transaction);
        }
        ...
        {
            return SimpleCRUD.GetList<T>(conn, conditions, parameters, transaction);
        }
        ...
        public virtual IEnumerable<T> GetListPaged<T>(this IDbConnection connection, int pageNumber, int rowsPerPage, string conditions, string orderby, object parameters = null, IDbTransaction transaction = null, int? commandTimeout = null)
        {

            return SimpleCRUD.GetListPaged<T>(conn, pageNumber, rowsPerPage, conditions, orderby, parameters, transaction);
        }
        ...
        ////{
        ////    return SimpleCRUD.Insert<TEntity>(conn, entityToInsert, transaction);
        ////}
        ...
        ////{
        ////    return SimpleCRUD.Insert<TKey, TEntity>(conn, entityToInsert, transaction);
        ////}
        ...
        ////{
        ////    return SimpleCRUD.Update<TEntity>(conn, entityToUpdate, transaction);
        ////}
        ...
        public virtual int Delete<T>(T entityToDelete)
        {
            ...
            return SimpleCRUD.Delete<T>(conn, entityToDelete, transaction);
        }
        ...
        public virtual int Delete<T>(object id)
        {
            ...
            return SimpleCRUD.Delete<T>(conn, id, transaction);
        }
        ...
        public virtual int DeleteList<T>(object whereConditions)
        {
            ...
            return SimpleCRUD.DeleteList<T>(conn, whereConditions, transaction);
        }
        ...
        public virtual int DeleteList<T>(string conditions, object parameters = null)
        {
            ...
            return SimpleCRUD.DeleteList<T>(conn, conditions, parameters, transaction);
        }
        ...
        public virtual int RecordCount<T>(string conditions = "", object parameters = null)
        {
            ...
            return SimpleCRUD.RecordCount<T>(conn, conditions, parameters, transaction);
        }
        ...
        {
            return SimpleCRUD.RecordCount<T>(conn, whereConditions, transaction);
        }
    ...
    //////  public static partial class BaseBll
    //////<TEntity, TKey> where TEntity : Entity, new()
    ////public static class RepositoryBase<TEntity, TKey> where TEntity : Entity, new()

    ////{
    ////    private IDbConnection conn;
    ////    private IDbTransaction transaction;

    ////    //public BaseBll(IDbConnection _conn, IDbTransaction _transaction)
    ////    //{
    ////    //    conn = _conn;
    ////    //    transaction = _transaction;
